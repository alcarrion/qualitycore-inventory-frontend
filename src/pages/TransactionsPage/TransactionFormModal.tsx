// TransactionsPage/TransactionFormModal.tsx
                  ...
                  <DropdownItem key={p.id} highlighted={idx === productDropdown.highlightedIndex} onClick={() => onSelectProduct(p)}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                      ...
                      <div style={{ textAlign: 'right', marginLeft: '12px' }}>
                        ...
                        <div style={{
                          fontSize: '0.75em',
                          color: (p.availableStock ?? p.current_stock) > (p.minimum_stock ?? 0) ? 'var(--text-success)' : 'var(--text-danger)',
                          fontWeight: '500'
                        }}>
                ...
                >
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ fontSize: '12px', color: 'var(--text-secondary)' }}>
                      ${parseFloat(String(item.product.price)).toLocaleString('es-EC', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} × {item.quantity} = ${(item.product.price * item.quantity).toLocaleString('es-EC', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                    </div>
                  </div>
