...
describe("validateEcuadorianCedula", () => {
  ...
  test("rejects empty cedula", () => {
    ...
    expect(() => validateEcuadorianCedula(null as unknown as string)).toThrow(/vacía/);
  });
...
describe("validateEcuadorianRUC", () => {
  ...
  test("rejects empty RUC", () => {
    ...
    expect(() => validateEcuadorianRUC(null as unknown as string)).toThrow(/vacío/);
  });
...
describe("validatePassport", () => {
  ...
  test("rejects empty passport", () => {
    ...
    expect(() => validatePassport(null as unknown as string)).toThrow(/vacío/);
  });
